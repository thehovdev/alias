<template>
  <div class="p-4 max-w-lg mx-auto">
    <h1 class="text-xl font-bold mb-8 text-center text-gray-800">Liderlər</h1>
    <div class="overflow-x-auto bg-white shadow-md rounded-lg">
      <table class="w-full table-auto">
        <thead>
          <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
            <th class="py-3 px-4 text-left">Reyting</th>
            <th class="py-3 px-4 text-left">Oyunçu</th>
            <th class="py-3 px-4 text-right">Yekun Hesab</th>
          </tr>
        </thead>
